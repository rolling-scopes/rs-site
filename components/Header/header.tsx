...
export default function Header({ logo }: Props) {
  return (
    <div className="flex justify-center bg-[#FFDB1F]">
      <header className="container flex justify-between items-center px-4 py-2">
        <div
          className={`flex justify-center items-center font-sans font-black text-2xl rounded-full aspect-square w-16 ${
            logo === 'circle' ? 'bg-black text-[#FFDB1F]' : 'text-black'
          }`}
        >
          RS
        </div>
        ...
        <div className="flex justify-center">
          ...
          <select className="bg-transparent text-gray-700 hover:text-gray-900 ml-1 cursor-pointer">
