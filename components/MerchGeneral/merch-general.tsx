...
export default function MerchGeneral({merch}: Props) {
    ...
    const picList = imagesList.map((item) =>
        <div className="h-64 w-44 overflow-hidden rounded-lg sm:opacity-0 lg:opacity-100" key={item.caption}>
            <Image src={urlForImage(item).url()} alt="donation" width="235" height="100"
